...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-is_switch" class="form-control" name="row[is_switch]" type="number" value="<?php echo htmlentities($row['is_switch']); ?>">
        </div>
    </div>
    <div class="form-group">
