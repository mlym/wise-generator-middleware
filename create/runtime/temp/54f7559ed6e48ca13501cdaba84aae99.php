...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-user" class="form-control" name="row[user]" type="text" value="<?php echo htmlentities($row['user']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-database" class="form-control" name="row[database]" type="text" value="<?php echo htmlentities($row['database']); ?>">
        </div>
    </div>
    <div class="form-group">
