<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"D:\phpstudy_pro\WWW\code\create\public/../application/admin\view\mw_column\add.html";i:1622101554;s:74:"D:\phpstudy_pro\WWW\code\create\application\admin\view\layout\default.html";i:1617358420;s:71:"D:\phpstudy_pro\WWW\code\create\application\admin\view\common\meta.html";i:1617358420;s:73:"D:\phpstudy_pro\WWW\code\create\application\admin\view\common\script.html";i:1617358420;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-module_id" data-rule="required" data-source="mw_module/index" class="form-control selectpage" name="row[module_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-input_type" class="form-control" name="row[input_type]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Output_type'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-output_type" class="form-control" name="row[output_type]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Is_quick_search'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-is_quick_search" class="form-control" name="row[is_quick_search]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Is_multiple'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-is_multiple" class="form-control" name="row[is_multiple]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Prompt'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-prompt" class="form-control" name="row[prompt]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Placeholder'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-placeholder" class="form-control" name="row[placeholder]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Link'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-link" class="form-control " rows="5" name="row[link]" cols="50"></textarea>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Search_rule'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-search_rule" class="form-control " rows="5" name="row[search_rule]" cols="50"></textarea>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-option" class="form-control " rows="5" name="row[option]" cols="50"></textarea>
        </div>
    </div>
    <div class="form-group">
